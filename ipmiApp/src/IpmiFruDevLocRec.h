...
public:
    ...
    const IpmiSensorRecComp &get_sensor_by_sensor_number(uint8_t number) const;
    std::shared_ptr<IpmiSensorRecComp> get_sensor_by_sensor_number2(uint8_t number) const;
